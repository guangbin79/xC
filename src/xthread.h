 ...
 * @return - 无
 */
typedef void (*xfn_thread_proc)(void * pvUser);
 ...
 */
xthread * xthread_create(xfn_thread_proc proc, void * pvUser);
 ...
 */
xbool_t xthread_start(xthread * pxthread);
 ...
 */
xbool_t xthread_isExecuting(xthread * pxthread);
 ...
 * @return - 无
 */
void xthread_destory(xthread * pxthread);
