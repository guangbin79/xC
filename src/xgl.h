...
void xglGenBuffers (XGLsizei n, XGLuint* buffers);
void xglDeleteBuffers (XGLsizei n, const XGLuint* buffers);
void xglBindBuffer (XGLenum target, XGLuint buffer);
void xglBufferData (XGLenum target, XGLsizeiptr size, const XGLvoid* data, XGLenum usage);
void xglBufferSubData (XGLenum target, XGLintptr offset, XGLsizeiptr size, const XGLvoid* data);
XGLuint xglCreateShader (XGLenum type);
void xglGetShaderSource (XGLuint shader, XGLsizei bufsize, XGLsizei* length, XGLchar* source);
void xglCompileShader (XGLuint shader);
void xglGetShaderiv (XGLuint shader, XGLenum pname, XGLint* params);
void xglGetShaderInfoLog (XGLuint shader, XGLsizei bufsize, XGLsizei* length, XGLchar* infolog);
void xglDeleteShader (XGLuint shader);
XGLuint xglCreateProgram (void);
void xglAttachShader (XGLuint program, XGLuint shader);
void xglDeleteProgram (XGLuint program);
void xglLinkProgram (XGLuint program);
void xglUseProgram (XGLuint program);
void xglGetProgramiv (XGLuint program, XGLenum pname, XGLint* params);
void xglGetProgramInfoLog (XGLuint program, XGLsizei bufsize, XGLsizei* length, XGLchar* infolog)
int xglGetUniformLocation (XGLuint program, const XGLchar* name);
void xglUniform1f (XGLint location, XGLfloat x);
void xglUniform2f (XGLint location, XGLfloat x, XGLfloat y);
void xglUniform3f (XGLint location, XGLfloat x, XGLfloat y, XGLfloat z);
void xglUniform4f (XGLint location, XGLfloat x, XGLfloat y, XGLfloat z, XGLfloat w);
void xglUniformMatrix3fv (XGLint location, XGLsizei count, XGLboolean transpose, const XGLfloat* value);
void xglUniformMatrix4fv (XGLint location, XGLsizei count, XGLboolean transpose, const XGLfloat* value);
void xglUniform1i (XGLint location, XGLint x);
void xglAttachShader (XGLuint program, XGLuint shader);
void xglGetVertexAttribPointerv (XGLuint index, XGLenum pname, XGLvoid** pointer);
void xglEnableVertexAttribArray (XGLuint index);
void xglDisableVertexAttribArray (XGLuint index);
int  xglGetAttribLocation (XGLuint program, const XGLchar* name);
void xglGenFramebuffers (XGLsizei n, XGLuint* framebuffers);
void xglBindFramebuffer (XGLenum target, XGLuint framebuffer);
void xglFramebufferTexture2D (XGLenum target, XGLenum attachment, XGLenum textarget, XGLuint texture, XGLint level);
XGLenum xglCheckFramebufferStatus (XGLenum target);
void xglDeleteFramebuffers (XGLsizei n, const XGLuint* framebuffers);
void xglGenRenderbuffers (XGLsizei n, XGLuint* renderbuffers);
void xglBindRenderbuffer (XGLenum target, XGLuint renderbuffer);
void xglRenderbufferStorage (XGLenum target, XGLenum internalformat, XGLsizei width, XGLsizei height);
void xglFramebufferRenderbuffer (XGLenum target, XGLenum attachment, XGLenum renderbuffertarget, XGLuint renderbuffer);
void xglDeleteRenderbuffers (XGLsizei n, const XGLuint* renderbuffers);
